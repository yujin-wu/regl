...
function sendToHeavenWrapper(path, value) {
...
function linkHeavenlyObject(path, keys) {
  ...
  var result = new Proxy(obj, {
    ...
    set: function(target, name, value) {
      ...
      var toSend;
      if (typeof value === 'object' && value.__isHeavenlyObject) {
...
function prepareArguments(args) {
  ...
  return args.map(function (arg) {
    ...
    if (typeof arg === 'object' && arg.__isHeavenlyObject) {
      return {
        type: 'object',
        path: arg.__path,
      };
